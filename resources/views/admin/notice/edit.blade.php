                ...
                <div class="col-lg-10 col-md-8 mx-auto">
                    <div class="card card-info">
                        <div class="card-header">
                            <h5 class="text-center mt-2">Edit notice</h5>
                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="notice_name"
                                                    value="{{ old('notice_name') ? old('notice_name') : $notice->name }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="notice_description" id="summernote"
                                                    required>{{ old('notice_description') ? old('notice_description') : $notice->description }}</textarea>
