...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">List designation</h1>
            </div>
            <!-- /.col -->
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <div class="card-title text-center">
                            Designation
                            <a href="{{ route('admin.designation.create') }}" class="">
                    ...
                    <div class="card-body">
                        ...
                        @for ($i = 1; $i < $designations->count()+1; $i++)
                            <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                        <div class="card card-danger">
                                            ...
                                            <div class="card-body text-center d-flex" style="justify-content: center">
                                                ...
                                                <form
                                                    action="{{ route('admin.designation.destroy', $designations->get($i-1)->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
