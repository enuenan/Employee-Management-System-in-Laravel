                                    ...
                                    <tbody>
                                        @foreach ($expenses as $index => $expense)
                                            <tr>
                                                ...
                                                <td>{{ $expense->employee->first_name . ' ' . $expense->employee->last_name }}
                                                </td>
                                ...
                                @for ($i = 1; $i < $expenses->count() + 1; $i++)
                                    @if ($expenses->get($i - 1)->file)
                                        ...
                                        <div class="modal fade" id="exampleModalCenter{{ $i }}"
                                            ...
                                            aria-labelledby="exampleModalCenterTitle1{{ $i }}"
                                            aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="card card-info">
                                                    ...
                                                    <div class="card-footer text-center">
                                                        ...
                                                        <a
                                                            href="{{ route('admin.expenses.delete', $expenses->get($i - 1)->id) }}">
                                                            <button type="submit"
                                                                class="btn flat btn-danger">Delete</button>
                                                        </a>
                                                    </div>
                                                    </form>
                                                </div>
