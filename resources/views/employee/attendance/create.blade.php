                    ...
                    <div class="card card-info">
                        ...
                        @if (!$attendance)
                            <form role="form" method="post"
                                action="{{ route('employee.attendance.store', $employee->id) }}">
                            @else
                                <form role="form" method="post"
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry_location" id="entry_location" hidden required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-center" id="exit_loc"
                                                @if ($attendance) placeholder="Loading location..." @else placeholder="..." @endif disabled />
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="exit_ip">Exit IP Address</label>
                                            <input type="text" class="form-control text-center" id="exit_ip" name="exit_ip"
                                                value="{{ $attendance->exit_ip }}" placeholder="X.X.X.X" disabled
                                                style="background: #333; color:#f4f4f4" />
                                        </div>
                                    </div>
                                </div>
